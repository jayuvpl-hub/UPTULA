const registerOtpTemplate = (otp, userName) => {
  return `
  <div style="background:#0f172a;padding:20px;font-family:Arial,sans-serif;">
    ...
    <div style="max-width:520px;margin:auto;background:#111827;padding:25px;border-radius:12px;color:white;">
      ...
      <!-- Heading -->
      <h2 style="margin:0 0 10px;">Welcome to Uptula 🎉</h2>

      <!-- Intro -->
      <p style="color:#9ca3af;font-size:14px;line-height:1.6;">
        Welcome to Uptula Job Portal – your smart job search partner! <br/>
        To complete your registration and start exploring job opportunities, 
      ...
      <p style="color:#f87171;font-size:13px;margin-top:-10px;">
        ⚠️ Do not share this OTP with anyone. Uptula will never ask for your OTP.
      </p>
      ...
      <p style="text-align:center;font-size:14px;color:#d1d5db;">
        Start exploring jobs instantly on our App 🚀
      </p>
