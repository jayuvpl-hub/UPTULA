...
// Configure S3-backed upload for sponsorship images (was multer.diskStorage -> uploads/sponsorship)
const upload = makeUploader('sponsorship', { fileFilter: filters.imageOnly });
